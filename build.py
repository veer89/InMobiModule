...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','ti.inmobi.js')
	...
	f = os.path.join(cwd,'Classes','TiInmobiModuleAssets.m')
	c = open(f).read()
	idx = c.find('return ')
	before = c[0:idx]
	after = """
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','ti.inmobi.js']
